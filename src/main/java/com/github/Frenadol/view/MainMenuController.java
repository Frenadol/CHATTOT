        ...
        private void confirmAndAddContact() {
            ...
            if (selectedContact != null) {
                ...
                if (result.isPresent() && result.get() == ButtonType.OK) {
                    if (currentUser != null) {
                        // Verificar que el contacto no esté duplicado
                        if (!currentUser.getContacts().contains(selectedContact)) {
                            // Agregar contacto a la lista en memoria
                                ...
                                for (User user : users) {
                                    if (user.getName().equals(currentUser.getName())) {
                                        ...
                                        if (!existingContacts.contains(selectedContact)) {
                                            existingContacts.add(selectedContact);  // Agregar solo el nuevo contacto
                                        }
        ...
        private void loadContactsForCurrentUser() {
            ...
            if (currentUser != null) {
                ...
                for (User user : users) {
                    if (user.getName().equals(currentUser.getName())) {
                        contactList.clear();
                        contactList.addAll(user.getContacts());  // Cargar todos los contactos
